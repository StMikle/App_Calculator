...
class CalculateExpression {
    ...
    */
    ...
    fun calculateExpressionWithBrackets(expression: String): String {
        ...
        if (!expressionWithoutSpaces.containsBrackets()) return parseExpression(
    ...
    fun format(number: BigDecimal, scale: Int): String {
        var formatter = DecimalFormat("0.0E0")
...
*  */
    ...
    private fun calculate(expression: String, operator: String): BigDecimal {
        ...
        try {
            ...
            throw UnsupportedOperationException("Input Error")
